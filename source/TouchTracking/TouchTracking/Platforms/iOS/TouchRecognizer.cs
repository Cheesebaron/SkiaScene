...
namespace TouchTracking.Platforms.iOS;

internal sealed class TouchRecognizer : UIGestureRecognizer
{
    ...
    private static void FireEvent(TouchRecognizer recognizer, nint id, TouchActionType actionType, UITouch touch, bool isInContact)
    {
