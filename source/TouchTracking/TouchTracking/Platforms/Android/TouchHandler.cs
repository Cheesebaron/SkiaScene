...
public class TouchHandler : TouchHandlerBase<View>
{
    ...
    private static Dictionary<View, TouchHandler> _viewDictionary = new();

    private static Dictionary<int, TouchHandler> _idToTouchHandlerDictionary = new();
    ...
    public override void RegisterEvents(View view)
    {
        ...
        if (view is { Context: not null })
        {
            _slop = ViewConfiguration.Get(view.Context)?.ScaledTouchSlop ?? 0;
